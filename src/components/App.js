...
class App extends Component {
    ...
    try {
      ...
      if (provider.isMetaMask){
        ...
        if(provider.accounts[0] !== 'undefined'){
          ...
          web3 = new Web3(new Web3.providers.HttpProvider(`https://${network.network}.infura.io/v3/${infuraid}`))
        } else { // handle problem with providing data
          account = null
          network = null
          web3 = new Web3(new Web3.providers.HttpProvider(`https://${network}.infura.io/v3/${infuraid}`))
        }
      } else {
  ...
  render() {
    ...
    if(this.state.loading) {
      content = <p id="loader" className="text-center text-white"><br></br><br></br><br></br>Loading...</p>
    } else {
      content = <Main
        offQr={this.offQr}
